...
<head>
    ...
    <title>Karime Spa - Personal del spa</title>
</head>
<body>
...
<!-- contenido -->
    <div class="d-flex">
        <div class="col-md-6">
            <h3 class="titulos mx-4 mt-3"><a href="principal.php" class="text-decoration-none titulos"><i class="fa-solid fa-arrow-left"></i></a> Personal del spac</h3>
        </div>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="botonU" class="botones"><i class="fa-solid fa-save"></i> Guardar</button>
                                    </div>
                                </form>
                                </div>
                            </div>
                ...
                <section class="tabla-container table table-responsive">
                    ...
                    <table class="tabla-spa" id="tabla">
                        ...
                        <?php foreach($usuarios as $i){ ?>
                            <tr class="articulo">
                               <td class="text-capitalize"><?php echo $i['nombre'] ?></td> 
                               <td class="text-capitalize"><?php echo $i['apellido'] ?></td> 
                               <td class="text-capitalize"><?php echo $i['telefono'] ?></td> 
                               <td><?php echo $i['correo'] ?></td> 
                               <td><label class="rounded-pill text-capitalize <?php if($i['sucursal']=='apartado'){echo 'bg-warning';}else if($i['sucursal']=='sahagun'){echo 'bg-primary';}else{echo 'bg-danger';} ?> p-1 text-white"><?php echo $i['sucursal'] ?></label></td> 
                               <td><a type="button" onclick="eliminar('<?php echo $i['id_usuario'] ?>');" class="text-decoration-none btn btn-danger">Eliminar</a></td>
                               <h5 id="mensaje" style="display:none; color:red;" class="text-center">
    ...
    <script src="js/guardarU.js"></script>
