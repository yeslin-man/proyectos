                ...
                <div class="mt-3 sticky-top shadow-lg p-3 mb-5 rounded tarjetaBu">
                    ...
                    <div class="text-start">
                        <details>
                            ...
                            ?>
                                <a type="button"  data-id="<?php echo $i['id_servicio'] ?>" data-sucursal="<?php echo $i['sucursal'] ?>" class="mb-1 mt-1 sucursal text-decoration-none text-dark filtroSucursal"><?php echo $i['sucursal'] ?></a><br>
                            <?php 
                        ...
                        <details>
                            ...
                            <?php foreach($usuarios as $i){ ?>
                                <a type="button" data-id="<?php echo $i['id_servicio'] ?>" data-sucursal="<?php echo $i['sucursal'] ?>" data-servicio="<?php echo $i['servicio'] ?>" class="mt-1 sucursal text-decoration-none text-dark filtroServicio"><?php echo $i['servicio'] ?></a><br>
                            <?php } ?>
                        </details>
                    </div>
                </div>
